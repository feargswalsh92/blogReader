...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCUmGv6pm2lmWvPlGDAVWKEQr0-IIneFY0")
            ...
            if error != nil {
                ...
                if let urlContent = data {
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? NSArray { //where app is refreshed
